    ...
    return (
        <div className='w-11/12 max-w-3xl text-center mx-auto h-screen flex flex-col items-center justify-center gap-4'>
            <motion.div 
                ...
                <Image src={assets.my_pic} alt='' className='w-full h-full object-cover'/>
            </motion.div>  
            <motion.h3 
                initial={{y: -20, opacity: 0}}
                whileInView={{y: 0, opacity: 1}}
                transition={{duration: 0.6, delay: 0.3}}
                className='flex items-end gap-2 text-xl md:text-2xl mb-3 font-ovo'>Hi! I'm Vivek Papola <Image src={assets.hand_icon} alt='' className='w-6'/></motion.h3>
            <motion.h1 
            ...
            <motion.p 
                ...
                I am a Full Stack Developer studying in Graphic Era University, Dehradun 
            </motion.p>
